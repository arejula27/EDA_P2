...
//PRE:-
//POS: si(!existe(c,key)) se añade la nueva terna a coleccion, 
//  sino no se modifica
...
//PRE: -
//POS: si (existe(c,key) -> se sustituye la terna (k,data,rep) por (k,data,rep+1)
//      sino no se modifica
template <typename D, typename K>
...
//      pero sin la terna con clave key, en caso contrario devuelve la
//      colección igual
template <typename D, typename K>
...
//PRE: -
//POS: devuelve el numero de ternas en la coleccion c
template <typename D, typename K>
...
//PRE: -
//POS: devuelve true si quedan ternas por visitar de la coleccion c
template <typename D, typename K>
bool existeSiguiente(coleccion<D, K> &c);

//PRE: c.existeSiguiente(c)
//POS: key = clave de la siguiente terna a visitar de c
template <typename D, typename K>
bool siguienteClave(coleccion<D, K> &c, K &key);

//PRE: c.existeSiguiente(c)
//POS: data = dato de la siguiente terna a visitar de c
template <typename D, typename K>
bool siguienteDato(coleccion<D, K> &c,D &data);

//PRE: c.existeSiguiente(c)
//POS: rep= natural de la siguiente terna a visitar de c
template <typename D, typename K>
bool siguienteNumero(coleccion<D, K> &c, int &rep);

//PRE: c.existeSiguiente(c)
//POS: Prepara el iterador para visitar la siguiente terna de la colección c
template <typename D, typename K>
...
//PRE: c.existeSiguiente(c)
//POS: key = clave de la siguiente terna a visitar de la coleccion c, devuelve false si no existe siguiente
template <typename D, typename K>
bool siguienteClave(coleccion<D, K> &c, K &key){
...
//PRE: c.existeSiguiente(c)
//POS: data = dato de la siguiente terna a visitar de la coleccion c
template <typename D, typename K>
bool siguienteDato(coleccion<D, K> &c, D &data){
...
//PRE: c.existeSiguiente(c)
//POS: rep= natural de la siguiente terna a visitar de la coleccion c
template <typename D, typename K>
bool siguienteNumero(coleccion<D, K> &c, int &rep){
